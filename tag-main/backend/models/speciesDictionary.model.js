...
SpeciesDictionary.init(
  {
    ...
    category: {
      type: DataTypes.ENUM("fish", "aquaticplants", "macroalgae"),
      //defaultValue: "fish",
      allowNull: false,
    },
    family: {
    ...
    care_level: {
      type: DataTypes.ENUM("very_easy", "easy", "moderate", "difficult", "expert", "very_difficult"),
   ...
   lifespan_years: { type: DataTypes.STRING(100) },
   social_needs: { type: DataTypes.TEXT },
   filtration_requirement: { type: DataTypes.STRING(255) },
   common_diseases: { type: DataTypes.JSONB },
   varieties: { type: DataTypes.TEXT },
   bioload: { type: DataTypes.STRING(255) },
   recommended_substrate: { type: DataTypes.STRING(255) },
   plant_safety: { type: DataTypes.STRING(255) },
   breeding_triggers: { type: DataTypes.TEXT },
   spawning_process: { type: DataTypes.TEXT },
   fry_development: { type: DataTypes.JSONB },
   tank_mates: { type: DataTypes.TEXT },
   common_myths: { type: DataTypes.TEXT },
  },
