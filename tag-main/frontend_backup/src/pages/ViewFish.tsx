        ...
        <div className="flex flex-col lg:flex-row gap-6 relative">
          ...
          <div className="flex-1 lg:order-1 text-[0.95rem] leading-[1.6] text-foreground">
            ...
            <div className="mb-4">
              ...
              <div className="my-6 p-4 border border-border bg-muted/10 max-w-2xl">
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    {showPhInfo && (
                      <div
                        className="absolute z-50 bg-popover border border-border rounded-xl shadow-xl p-4 min-w-[320px] max-w-[340px]"
                        style={{ left: phTooltipPos.x, top: 48 }}
                        onMouseEnter={() => {
                      ...
                      >
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-8 h-8 rounded bg-gradient-to-r from-red-500 via-green-400 to-blue-600 border border-border" />
                          <div>
                        ...
                        <div className="text-sm bg-muted/50 rounded p-2 mb-2 text-foreground">
                          {phInfo.description}
                        </div>
                        ...
                        <a
                          ...
                          className="block text-center mt-2 px-3 py-1 rounded bg-primary/10 text-primary font-medium hover:bg-primary/20 transition w-full"
                        >
