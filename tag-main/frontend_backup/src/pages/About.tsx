                ...
                <div className="relative mt-6">
                  <div className="flex items-start">
                    ...
                    <p className="text-base md:text-lg text-foreground leading-relaxed flex-1" style={{ paddingTop: '0.5rem' }}>
                      <span className="inline-block">As a lifelong fishkeeping enthusiast, I founded The Aqua Guide</span>
                      <span className="block">to make expert knowledge accessible to everyone. Whether you're</span>
                      <span className="block">setting up your first tank or troubleshooting a complex issue,</span>
                      <span className="block">we're here to help you succeed.</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-1/2 text-foreground">
                ...
                <div className="relative mt-6">
                  <div className="flex items-start">
                    <span className="text-7xl md:text-8xl font-serif text-[hsl(var(--primary))] leading-none font-bold flex-shrink-0 mr-4" style={{ lineHeight: '0.75', paddingTop: '0.25rem' }}>"</span>
                    <p className="text-base md:text-lg text-foreground leading-relaxed flex-1" style={{ paddingTop: '0.5rem' }}>
                      <span className="inline-block">Specializing in saltwater aquariums and coral care, I focus on</span>
                      <span className="block">breaking down complex marine concepts into practical, actionable</span>
                      <span className="block">advice. My goal is to help you create and maintain a thriving</span>
                      <span className="block">marine ecosystem.</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              <Card
                ...
                className={`cursor-pointer hover:shadow-lg transition-all ${
                  subject === SUBJECTS.SUGGEST_GUIDE
