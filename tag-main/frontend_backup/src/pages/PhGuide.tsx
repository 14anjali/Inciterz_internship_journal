...
const PhGuide = () => (
	<div className="container mx-auto px-4 py-10 min-h-screen">
		...
		<div className="flex flex-col items-center mb-10">
			...
			/>
			<h1 className="text-4xl font-extrabold mb-2 text-center text-foreground">Aquarium pH Guide</h1>
		...
		<div className="flex flex-col items-center mb-10">
			<h2 className="text-2xl font-semibold mb-4 text-center text-foreground">Understanding the pH Scale</h2>
        ...
        `}>
			...
			<div className="mt-4 text-center text-muted-foreground max-w-xl">
				<span className="font-semibold text-foreground">pH</span> measures how acidic or alkaline your aquarium water is. Most freshwater fish thrive in a pH
