...
const Contact = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <Card onClick={() => setSubject(SUBJECTS.REPORT_BUG)} className={`cursor-pointer hover:shadow-lg transition-all hover:-translate-y-1 ${subject === SUBJECTS.REPORT_BUG ? 'ring-2 ring-primary' : ''}`}>
        <CardContent className="p-6 text-center">
