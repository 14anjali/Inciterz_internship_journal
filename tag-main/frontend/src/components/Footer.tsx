...
import { Fish, BookOpen, MessageSquare, Users, Megaphone } from "lucide-react";
...
const Footer = () => {
  const { adsVisible, setAdsVisible } = useAdsVisibility();
  return (
    <footer className="border-t bg-card mt-auto">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t mt-8 pt-8 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-sm text-muted-foreground">
